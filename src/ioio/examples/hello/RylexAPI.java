...
public class RylexAPI
{
	...
	public double degreesRightX = 2.3;
	public double degreesLeftX = 2.2;
	...
	public void turnRightWheelBack(int speed, int pulses) throws Exception
	{
	...
	public void turnLeftWhellBack(int speed, int pulses) throws Exception
	{
	...
	public void test() throws Exception
	{
		...
		log("spinRight at defaultSpeed for 90Á");
		spinRight(defaultSpeed, 90);
		sleep(500);
		log("spinLeft at defaultSpeed for 90Á");
