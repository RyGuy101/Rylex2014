...
//			fixSelf();
	...
	public void checkForAlignment() throws Exception
	{
	...
	public void checkForBackwardAlignment() throws Exception
	{
		if (rearSensor < wallDistance)
		{
			backwardAlign();
			readSensors();
		}
	...
	public void backwardAlign() throws Exception
	{
		...
		ra.goForward(defaultSpeed, 1);
		ra.turnLeftWhellBack(100, 100);
		ra.goForward(defaultSpeed, 1);
		ra.turnRightWheelBack(100, 100);
		if (gridSquares.get(counter).getDirection() == NORTH)
		{
